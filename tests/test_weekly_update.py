...
class TestMainFunction:
    ...
    @patch("weekly_update.sys.exit")
    def test_api_usage_exceeded_exits_with_error(
        self, mock_exit, mock_check_usage, mock_get_week, mock_is_active
    ):
    ...
    @patch("weekly_update.sys.exit")
    def test_all_checks_pass_runs_import(
        self, mock_exit, mock_run_import, mock_check_usage, mock_get_week, mock_is_active
    ):
